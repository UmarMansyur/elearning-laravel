<div class="top-navbar flex-between gap-16">
  ...
  <div class="flex-align gap-16">
    ...
    <form action="#" class="w-350 d-sm-block d-none">
      <select name="select" id="select" class="form-select bg-gray-100 border-0 text-gray-500">
        <option value="1">Pilih Mapel</option>
        <option value="2">Course 1</option>
        <option value="3">Course 2</option>
        <option value="4">Course 3</option>
      </select>
    </form>
  </div>
              ...
              <div class="py-8 px-24 bg-main-600">
                <div class="flex-between">
                  ...
                  <div class="flex-align gap-12">
                    <button type="button" class="bg-white rounded-6 text-sm px-8 py-2 hover-text-primary-600"> New
                    </button>
              ...
              <div class="p-24 max-h-270 overflow-y-auto scroll-sm">
                  ...
                  <div class="border-bottom border-gray-100 mb-24 pb-24">
                    <div class="flex-align gap-4">
                      <a href="#" class="fw-medium text-15 mb-0 text-gray-300 hover-text-main-600 text-line-2">
                        Tim Pengadian Fakultas Keguruan dan Ilmu Pendidikan Universitas Madura@2024</a>
                      </a>
                      <!-- Three Dot Dropdown Start -->
                      <div class="dropdown flex-shrink-0">
                        <button class="text-gray-200 rounded-4" type="button" data-bs-toggle="dropdown"
                          aria-expanded="false">
                ...
                <div class="d-flex align-items-start gap-12">
                  <img src="/assets/images/thumbs/notification-img2.png" alt=""
                    class="w-48 h-48 rounded-circle object-fit-cover">
                  <div class="">
                    <a href="#" class="fw-medium text-15 mb-0 text-gray-300 hover-text-main-600 text-line-2">Patrick
